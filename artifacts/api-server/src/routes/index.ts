...
import authSamlRouter from "./authSaml";
...
import aiConstituentsRouter from "./aiConstituents";
import savedReportViewsRouter from "./savedReportViews";
import savedConstituentSearchesRouter from "./savedConstituentSearches";
...
router.use(aiRouter);
router.use(aiConstituentsRouter);
router.use(savedReportViewsRouter);
router.use(savedConstituentSearchesRouter);
