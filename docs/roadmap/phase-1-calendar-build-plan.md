...
Status update (2026-06-02): schema exports, private calendar CRUD routes, private event scheduling routes, read-only public calendar JSON/ICS endpoints, tokenized ICS feed regeneration, a public read-only calendar page, and an authenticated calendar management panel have been added for the core Phase 1 calendar tables. Richer visibility/share/embed controls, route integration tests, and generated API client coverage remain follow-up items.
