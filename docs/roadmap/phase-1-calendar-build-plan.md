...
Status update (2026-06-02): schema exports and private calendar CRUD routes have been added for the core Phase 1 calendar tables. Event scheduling routes, public feed endpoints, richer visibility rules, and UI workflows remain the next implementation items.
